...
if (env === "dev") {
    ...
    apiBaseUrl = "http://34.207.216.247/api/v1/";
}
...
var Calculator = function () {
    ...
    var getSamples = function getSamples(domain, category, _success, failure) {
        $.ajaxSetup({
            headers: {
    ...
    var init = function init() {
        getSamples(_domain, _category, function (samples) {
            ...
            $_domain.change(function (event) {
                ...
                getSamples(_domain, _category, function (response) {
                    _data = response;
                    calculate();
                });
            });
            ...
            $_category.change(function (event) {
